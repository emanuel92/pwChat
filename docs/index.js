...
function connectToWebSocket() {
  ...
  socket.onerror = function(event) {
    console.error(event);
    log(
      "WebSocket Connection Error. Make sure web socket URL is correct and web socket server is up and running at - " +
        webSocketConnection
    );
  };
